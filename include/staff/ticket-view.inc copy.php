...
foreach (DynamicFormEntry::forTicket($ticket->getId()) as $form) {
    ...
    <thead>
        <th colspan="4"><?php echo Format::htmlchars($form->getTitle()); ?></th>
    </thead>
    <tbody>
    <?php
    $counter = 0;
...
// If odd number of fields, close the last row
if ($counter % 2 != 0) echo '<td colspan="2"></td></tr>';
?>
</tbody>
